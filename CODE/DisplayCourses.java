...
public class DisplayCourses extends CourseManip{
  ...
  public int menu(){
      ...
      System.out.println("1. View All the courses");
      System.out.println("2. Update the courses");
      System.out.println("3. View the courses of the current student");
      System.out.println("4. Update the student's courses");
